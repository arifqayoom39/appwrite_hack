...
class _ShopPreviewScreenState extends State<ShopPreviewScreen>
  ...
  // We'll use the ShopThemes class for theme definitions
  ...
  Widget build(BuildContext context) {
    ...
    final currentTheme = ShopThemes.getThemeByName(_selectedTheme);
  ...
  LinearGradient _getThemeGradient(String themeName) {
    return ShopThemes.getThemeGradient(themeName);
  }
            ...
            child: Column(
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemCount: ShopThemes.getThemes().keys.length,
                  itemBuilder: (context, index) {
                    final themeName = ShopThemes.getThemes().keys.elementAt(index);
  ...
  String _getThemeDescription(String themeName) {
    return ShopThemes.getThemeDescription(themeName);
  }
